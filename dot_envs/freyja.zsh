...
__conda_setup="$('/Users/jvanhare/desktop/wkdir/conda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/jvanhare/desktop/wkdir/conda/etc/profile.d/conda.sh" ]; then
        . "/Users/jvanhare/desktop/wkdir/conda/etc/profile.d/conda.sh"
    else
        export PATH="/Users/jvanhare/desktop/wkdir/conda/bin:$PATH"
    fi
fi
unset __conda_setup
